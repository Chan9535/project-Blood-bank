...
<h1 style="padding-left:6%;
   font-weight: bold;
    color: #f56a79;
    line-height: 1.5;">Details of Blood Banks in your City</h1>

<h3 style="text-align: center; padding-right:12%; color:#fff;">Blood Bank Details</h3>
