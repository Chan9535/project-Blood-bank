    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav ">
          ...
          <li class="nav-item">
            <a class="nav-link nv" href="">Find blood</a>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link in" href="signui.html">sign in</a>
          </li>
          <li class="nav-item">
            <a class="nav-link up" href="register.html">Register</a>
        </ul>
        </ul>
      </div>
    </nav>
        ...
        <div class="container">
          <form class="regfm" id="f2" action="req_connect.php" method="post">
            <div class="limg">
              ...
              <h1 style="font-size:40px;">Post Your Requirement</h1>
            </div>
            <div class="row">
              <div class="col-lg-6">
                <div class="ifm">
          ...
          <button type="submit" form="f2" name="submit" class="bttn">Submit</button>
        </div>
      </div>
    </div>
